...
- (void)drawRect:(CGRect)rect {
    ...
    CGSize backgroundStretchPoints = {4, 9}, fillStretchPoints = {3, 7};
    
    // Initialize the stretchable images.
    UIImage *background = [[UIImage imageNamed:@"progress-bar-background.png"] stretchableImageWithLeftCapWidth:backgroundStretchPoints.width 
